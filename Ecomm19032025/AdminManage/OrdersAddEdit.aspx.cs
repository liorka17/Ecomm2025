    ...
    public partial class OrdersAddEdit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (o != null && o.OrderId != -1)
                {
                    ...
                    TxtOrderDesc.Text = o.OrderDesc; // <<< שים לב, תביא את התיאור למסך
                ...
                else
                {
                    ...
                    TxtOrderDesc.Text = ""; // תאפס את התיאור אם זה חדש
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            Orders o = new Orders()//יוצרת אובייקט חדש של הזמנה
            {
                ...
                OrderDesc = TxtOrderDesc.Text  // <<< שים לב, זה חייב להיות כאן
            };
