    ...
    <div class="card shadow mb-4" style="max-width: 650px;">
        ...
        <div class="card-body">
            ...
            <div class="form-group mb-3">
                ...
                <asp:TextBox ID="TxtPdesc" runat="server" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="10" placeholder="תיאור המוצר" />
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CntFooter" runat="server">
    <!-- הפעלת TinyMCE על שדה תיאור -->
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            tinymce.init({
                selector: '#<%= TxtPdesc.ClientID %>',
                height: 300,
                language: 'he_IL',
                directionality: 'rtl',
                plugins: [
